...
<script type="module">
  ...
  margin: 64px auto 48px auto;
    ...
    box-shadow: 0 0 20px rgba(128, 207, 44, 0.5);
    text-align: center;
    `;
  ...
  const instructionsHTML = `
    ...
    <div id="images" style="display:flex; justify-content:center; gap:20px; margin-bottom:14px;">
      <button id="rock-btn" style="background:none; border:none; padding:0; cursor:pointer;">
        <img id="rock-img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Logan_Rock_Treen_closeup.jpg/500px-Logan_Rock_Treen_closeup.jpg"
      ...
      <button id="paper-btn" style="background:none; border:none; padding:0; cursor:pointer;">
        <img id="paper-img" src="https://upload.wikimedia.org/wikipedia/commons/e/ea/Paperball_2.jpeg"
             style="width:100px; border:2px solid white; border-radius:10px;">
      </button>
      <button id="scissors-btn" style="background:none; border:none; padding:0; cursor:pointer;">
        <img id="scissors-img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Standard_household_scissors.jpg/500px-Standard_household_scissors.jpg"
             style="width:100px; border:2px solid white; border-radius:10px;">
      </button>
    </div>
  ...
  battleCanvas.style.background = '#da1212ff';
  ...
  rockImg.src = 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Logan_Rock_Treen_closeup.jpg/500px-Logan_Rock_Treen_closeup.jpg';
  const paperImg = new Image();
  paperImg.src = 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Paperball_2.jpeg';
  const scissorsImg = new Image();
  scissorsImg.src = 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Standard_household_scissors.jpg/500px-Standard_household_scissors.jpg';
  ...
  ctx.restore();
    ...
    if(battle.active){
      ...
      if(battle.tie){
        ...
        if(battle.winner === "scissors" && battle.loser === "rock"){
          l.rotation = -t * (Math.PI/4);
        }
        if(battle.winner === "rock" && battle.loser === "paper"){
          // paper "covers" rock by moving slightly past center
          w.targetX = l.homeX - 6; w.targetY = l.homeY - 6;
        }
        if(battle.winner === "paper" && battle.loser === "scissors"){
